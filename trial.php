...
-->
                <section >
                  ...
                  <ul>
                    <li>ステップ1<br>
<strong>電話の場合:</strong>平日月から金の9:00~13:30の間にてお申し込みのお電話をください[Tel:047-711-3080]<br>
(!これ以外の時間帯は授業に出払ってしまっています)。<br>
<strong>メールの場合:</strong>info@find18teach.proあてへ都合の良い日程をご相談ください。
</li>
　　　　　　　　　
                    <li>以上のご相談時に、Zoomのパスワード等をお伝えさせていただきます。</li>
                    <li>ステップ2 <br>体験授業を受けたのち、継続受講される場合のみご連絡いただくことになります<br>
                      継続される場合は単純に授業回数×500円以外の費用は発生しません。<br>
                      授業料は銀行振り込みとなります[振込手数料はご負担をご了承ください]。</li>
                  </ul>
 <!--               <h2><?=$message;?></h2>
                           <?php if($err_message !== ''):?>
...
　　　　　　　　　　　　　　　　　　　　<input type='hidden' value='<?=date(' l jS \of F Y h:i:s A');?>' name='date'>
         ...
         <footer>
                <h3>学習舎の数学講座 &lt; &copy; &gt;</h3>
　　　　　　　　<p class='footer_infomation'>学習舎:千葉県船橋市東中山1丁目14番<br>
                                             Tel:047-711-3080<br>
                                             Email:info@find18teach.pro</p>
         </footer>
